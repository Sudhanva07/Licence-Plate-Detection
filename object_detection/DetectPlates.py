...
def detectPlatesInScene(imgOriginalScene):
    ...
    if OCRlicense.showSteps == True: # show steps #######################################################
    ...
    if OCRlicense.showSteps == True: # show steps #######################################################
        ...
        cv2.drawContours(imgContours, contours, -1, OCRlicense.SCALAR_WHITE)
    ...
    if OCRlicense.showSteps == True: # show steps #######################################################
        ...
        for i in range(0, len(listOfPossiblePlates)):
            ...
            cv2.line(imgContours, tuple(p2fRectPoints[0]), tuple(p2fRectPoints[1]), OCRlicense.SCALAR_RED, 2)
            cv2.line(imgContours, tuple(p2fRectPoints[1]), tuple(p2fRectPoints[2]), OCRlicense.SCALAR_RED, 2)
            cv2.line(imgContours, tuple(p2fRectPoints[2]), tuple(p2fRectPoints[3]), OCRlicense.SCALAR_RED, 2)
            cv2.line(imgContours, tuple(p2fRectPoints[3]), tuple(p2fRectPoints[0]), OCRlicense.SCALAR_RED, 2)
...
def findPossibleCharsInScene(imgThresh):
    ...
    for i in range(0, len(contours)):                       # for each contour
        ...
        if OCRlicense.showSteps == True: # show steps ###################################################
            cv2.drawContours(imgContours, contours, i, OCRlicense.SCALAR_WHITE)
        # end if # show steps #####################################################################
