...
def recognizeCharsInPlate(imgThresh, listOfMatchingChars):
    ...
    for currentChar in listOfMatchingChars:                                         # for each char in plate
        ...
        cv2.rectangle(imgThreshColor, pt1, pt2, OCRlicense.SCALAR_GREEN, 2)           # draw green box around the char
        ...
        # strCurrentChar = pytesseract.image_to_string(imgROIResized)
